...
public class PropertiesLoaderUtils {
    ...
    public static String getConfiguration(String fileName, String key) {
        try {
    ...
    public static void setConfiguration(String fileName, String key, String value) {
        try {
            PropertiesConfiguration config = new PropertiesConfiguration(fileName);
    ...
    public static void removeConfiguration(String fileName, String key) {
        try {
            PropertiesConfiguration config = new PropertiesConfiguration(fileName);
